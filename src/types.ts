export type ToolCategory = 'pdf' | 'image' | 'text' | 'finance' | 'developer' | 'seo' | 'ai' | 'system' | 'content';
...
export const CATEGORIES = [
  ...
  { id: 'content' as ToolCategory, name: 'Content Management', icon: 'Layout', desc: 'View articles, news, and downloads' },
];
...
Provide clear, detailed context. The more precise your text input is, the more accurate and polished the model's generated response will be. Strip out unstructured notes and focus on your core messages.`
  ...
  {
    id: 'ai-clone-architect',
    name: 'AI Website Clone Planner',
    category: 'ai',
    iconName: 'Globe',
    description: 'Generate optimized multi-phase replication plans and design system specifications to clone any website.',
    summary: 'Input any URL to instantly design audit plans covering tech stacks, styling variables, responsive breakpoints, component specs, site structures, and ready-to-run starter codes.',
    seoGuide: `## Engineering Blueprint: Website Replication & System Decomposition

Systematic decomposition of existing web platforms is a prerequisite to successful, component-by-component front-end cloning. By breaking down a website’s visible layers, digital architects can map visual layout trees without looking at backend source codes.

### The Six Phases of Decomposition

1. **Reconnaissance**: Scan active DOM structures, identify frontend frameworks, and map structural sections.
2. **Design System Auditing**: Pull down exact styling tokens, CSS margins, color variables, matching fonts, and radii profiles.
3. **Component Mapping**: Identify the core UI components, including the sticky headers, responsive drawers, hero zones, information cells, and global footers.
4. **Interaction Analysis**: Note key transition timing, animations, state toggles, and responsive breakpoints.
5. **Structural Blueprinting**: Outline the absolute folder directory structure, asset collection lists, and priority-focused action plans.
6. **Shell Implementation**: Spawn immediate typography baselines, general layouts, and primary hero components.`
  },
  {
    id: 'hidden-tool',
    name: 'Hidden Tool',
    category: 'ai',
    iconName: 'Sliders',
    description: 'Generate robust CMS architectures & prompts containing installers, databases, AdSense plugins, and analytics.',
    summary: 'Configure installer scripts, database schemas, and admin dashboard specs to build fully modular, secure CMS web shells instantly.',
    seoGuide: `## CMS System Planning: Structuring Database-Driven Multi-Page Frontends

Constructing solid, lightweight Content Management Systems (CMS) with standalone control panels requires highly cohesive system coordination across installers, schemas, views, and security wrappers.

### Fundamental CMS Architecture Pillars

1. **Self-Documenting Installer**: Automatically audits server extensions, establishes connection test queries, and stores localized credentials securely.
2. **Normalized Database Schema**: Tabulates relational fields mapping pages, system settings, menus, custom scripts, security tokens, and view counts.
3. **Unified Admin Workspace**: Centralizes settings over a multi-panel grid, avoiding fragmented configuration files.
4. **Targeted Monetization Hooks**: Inject and audit AdSense snippets, AMP elements, and dynamic analytical tracking tags without breaking frontend rendering pipelines.
5. **Unified Security Shielding**: Implements PDO prepared queries, defense-in-depth against Cross-Site Request Forgery (CSRF), and robust XSS content sanitizers.`
  },
  {
    id: 'admin-panel',
    ...
    description: 'Manage site content, articles, news, and files.',
    summary: 'Central hub for site administration.',
    seoGuide: 'Internal administrative dashboard for content management.'
  },
  {
    id: 'articles',
    name: 'Articles',
    category: 'content',
    iconName: 'FileText',
    description: 'Read professional articles.',
    summary: 'Professional articles.',
    seoGuide: 'Professional articles.'
  },
  {
    id: 'news',
    name: 'News',
    category: 'content',
    iconName: 'Newspaper',
    description: 'Read latest site news.',
    summary: 'Site news.',
    seoGuide: 'Site news.'
  },
  {
    ...
    category: 'content',
    iconName: 'Folder',
    description: 'Download site resources.',
    summary: 'Downloadable files.',
    seoGuide: 'Downloadable files.'
  },
  {
    id: 'n8n',
    ...
    summary: 'N8n automations.',
    seoGuide: 'N8n automations.'
  },
  {
    id: 'json-to-go-java',
