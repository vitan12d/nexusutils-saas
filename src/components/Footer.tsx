      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12">
        ...
        <div className="mt-16 pt-8 border-t border-slate-200/80 dark:border-slate-900/60 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-6 text-slate-450">
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="hover:text-slate-900 dark:hover:text-white transition-colors" aria-label="Our Twitter feed"><Twitter className="h-4 w-4" /></a>
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="hover:text-slate-900 dark:hover:text-white transition-colors" aria-label="GitHub platform details"><Github className="h-4 w-4" /></a>
            <a href="mailto:support@nexusutils.com" className="hover:text-slate-900 dark:hover:text-white transition-colors" aria-label="Support Mailbox"><Mail className="h-4 w-4" /></a>
          </div>
        </div>
